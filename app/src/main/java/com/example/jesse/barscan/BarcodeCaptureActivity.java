...
import com.example.jesse.barscan.ui.camera.CameraSource;
import com.example.jesse.barscan.ui.camera.CameraSourcePreview;
    ...
    public boolean onTap(float rawX, float rawY) {
        ...
        if (best != null) {
            ...
            try {
                ...
                else tbl.setBackgroundColor(Color.parseColor("#617C17"));

            } catch (ParseException e) {
                e.printStackTrace();
            }

            String cityContent = new String(sample.addressCity + ", " + sample.addressState
